...
const envSchema = z.object({
    ...
    LOGTO_MOBILE_API_AUDIENCE: optionalString,
    LOGTO_MANAGEMENT_APP_ID: optionalString,
    LOGTO_MANAGEMENT_APP_SECRET: optionalString,
    LOGTO_TEST_PROVISIONING_SECRET: optionalString,

    // Import providers (server-side only)
    GOOGLE_MAPS_API_KEY: optionalString,
    BUSINESS_IMPORT_RECOVERY_FROM_EMAIL: optionalString,
