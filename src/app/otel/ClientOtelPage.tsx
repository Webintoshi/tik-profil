...
import { BedDouble, ConciergeBell, Coffee, Wifi, Star, ArrowRight, Zap, CheckCircle, ChefHat, Bell } from "lucide-react";
                    ...
                    <div className="max-w-7xl mx-auto px-6 mb-24 text-center relative">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-7xl font-extrabold mb-8 text-slate-900 tracking-tight leading-none">
                                Misafir Deneyimini <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-sky-500">Mükemmelleştirin</span>
                            </h1>
