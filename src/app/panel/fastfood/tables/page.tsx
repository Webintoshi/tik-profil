...
function getFastFoodTableQRUrl(businessSlug: string, tableId: string): string {
    return `https://tikprofil.com/${businessSlug}/menu?table=${tableId}`;
}

export default function FastFoodTablesPage() {
    ...
    const copyQRUrl = (table: FBTable) => {
        const url = getFastFoodTableQRUrl(businessSlug, table.id);
                            ...
                            >
                                    ...
                                    {editingTable === table.id ? (
                                        <div className="flex items-center gap-1 flex-1">
                                            <input
                                                ...
                                                autoFocus
                                            />
                                            <button onClick={saveTableEdit} className="p-1 text-orange-500 hover:bg-orange-500/10 rounded">
                                ...
                                {businessSlug && (
                                    ...
                                    >
                                        <QRCodeSVG
                                            id={`qr-${table.id}`}
                                            value={getFastFoodTableQRUrl(businessSlug, table.id)}
                                            size={64}
                                            level="H"
                                ...
                                {businessSlug && (
                                    <div className="grid grid-cols-2 gap-1">
                                        ...
                                        <button
                                            ...
                                            className="py-1 px-1.5 rounded text-[9px] font-medium flex items-center justify-center gap-0.5 bg-orange-500 hover:bg-orange-600 text-white transition-colors"
                                        >
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="bg-white p-6 rounded-2xl mb-4">
                                <QRCodeSVG
                                    value={getFastFoodTableQRUrl(businessSlug, selectedTable.id)}
                                    size={256}
                                    level="H"
                                    className="w-full h-auto"
                                />
                            ...
                            <p className={clsx("text-sm text-center mb-4 break-all", textSecondary)}>
                                {getFastFoodTableQRUrl(businessSlug, selectedTable.id)}
                            </p>
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <button
                                    ...
                                    className="py-3 rounded-xl font-medium bg-orange-500 text-white flex items-center justify-center gap-2"
                                >
