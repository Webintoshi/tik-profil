...
test("QR target rejects unsafe or context-losing values", () => {
  const rejected = [
    ...
    "https://tikprofil.com/ordu%2fkahve",
    "https://tikprofil.com/ordu%252Fkahve",
    "https://tikprofil.com/ordu%255Ckahve",
    "https://tikprofil.com/ordu%5Ckahve",
    "https://tikprofil.com/valid%2eslug",
    "https://tikprofil.com/valid%252eslug",
    "https://tikprofil.com/./valid-slug",
    "https://tikprofil.com/../valid-slug",
    "https://tikprofil.com/foo/../valid-slug",
    "https://tikprofil.com/foo/./valid-slug",
    "https://tikprofil.com/foo/%2e%2e/valid-slug",
    "https://tikprofil.com/foo/%2E%2E/valid-slug",
    "https://tikprofil.com/foo/%252e%252e/valid-slug",
    "https://tikprofil.com/foo\\..\\valid-slug",
    "https://tikprofil.com/foo/%5c..%5cvalid-slug",
    "https://tikprofil.com/foo//valid-slug",
